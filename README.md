...
This action will find and replace strings in your project files. This is a fork that is built for ARM64.
  ...
  build:
    ...
    steps:
      ...
      - name: Find and Replace
        uses: seripap/gha-find-replace@v1
        with:
          find: "hello"
          replace: "world"
          regex: false
